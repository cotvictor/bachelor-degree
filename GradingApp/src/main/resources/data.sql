...
-- student
INSERT INTO `student`(`first_name`, `last_name`, `email`, `phone_no`, `scholarship`, `scope`, `group_id`) VALUES ('Diana','Miron','diana.miron@mail.com', 0745504532, TRUE, 'STUDENT', 1);
INSERT INTO `student`(`first_name`, `last_name`, `email`, `phone_no`, `scholarship`, `scope`, `group_id`) VALUES ('Alex','Valan','alex.valan@mail.com', 0745504932, FALSE, 'STUDENT', 1);